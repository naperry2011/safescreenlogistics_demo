...
## Booking Submission
Source: BookingWizard form state (client)
Transport: fetch POST /api/book (JSON)
...
## Query-Param Prefill
Source: links e.g. /book?service=iv-therapy, ?package=revive
Transport: URL search params (useSearchParams)
Processor: BookingWizard initial state
Downstream Consumers: wizard step 0 default selection
